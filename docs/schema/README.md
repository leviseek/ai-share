...
各配置源的字段说明：[`global.md`](global.md)、[`provider.md`](provider.md)、[`models.md`](models.md)、[`mcp.md`](mcp.md)、[`agents.md`](agents.md)、[`plugins.md`](plugins.md)、[`env.md`](env.md)、[`wezterm.md`](wezterm.md)。
