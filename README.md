...
memory/
├── user/                    # 用户身份与偏好
│   ├── profile.md           # 用户画像、编码风格
│   ├── workflow.md          # 开发流程、验证习惯
│   ├── preferences.md       # 工具与模型偏好
│   ├── devices.md           # 多设备配置
│   ├── toolchain.md         # 开发工具链
│   └── prompts.md           # Prompt 偏好
├── architecture/            # 架构与设计哲学
│   ├── coding-philosophy.md # 编码哲学
│   └── agent-patterns.md    # Agent 编排模式
└── stack/                   # 核心技术栈
    ├── opencode.md          # OpenCode 使用知识
    └── oh-my-openagent.md   # OMO 使用知识
```
