...
YAML source of truth for generated Codex CLI, Codex, profile MCP, and instruction-memory configuration.

## WHERE TO LOOK

| Need                                                   | File                | Notes                                         |
| ------------------------------------------------------ | ------------------- | --------------------------------------------- |
| Default profile and Codex version requirements         | `global.yaml`       | Only fields consumed by generator/check       |
...
| Codex profile role mapping                             | `profiles.yaml`     | `lite`, `cheap`, `balanced`, `coding`, etc.   |
